...
// Import and export VisuallyHidden for accessibility
  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        {...props}
      >
        {/* Automatically add a hidden DialogTitle if one doesn't exist for accessibility */}
        {!hasDialogTitle && (
