...
const SelectLabel = React.forwardRef(function SelectLabel(props, ref) {
  return <SelectPrimitive.Label ref={ref} className={cn("py-1.5 pl-8 pr-2 text-sm font-semibold", props.className)} {...props} />;
});
...
const SelectSeparator = React.forwardRef(function SelectSeparator(props, ref) {
  return <SelectPrimitive.Separator ref={ref} className={cn("-mx-1 my-1 h-px bg-muted", props.className)} {...props} />;
});
