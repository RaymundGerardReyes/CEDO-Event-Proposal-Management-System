...
const DrawerOverlay = React.forwardRef((props = {}, ref) => {
  ...
  return <DrawerPrimitive.Overlay ref={ref} className={cn("fixed inset-0 z-50 bg-black/80", className)} {...rest} />;
});
...
const DrawerTitle = React.forwardRef((props = {}, ref) => {
  const { className, ...rest } = props;
  return <DrawerPrimitive.Title ref={ref} className={cn("text-lg font-semibold leading-none tracking-tight", className)} {...rest} />;
});
