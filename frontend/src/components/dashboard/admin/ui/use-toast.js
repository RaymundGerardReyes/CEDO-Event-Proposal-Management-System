...
export function useToast() {
    ...
    // Only throw if context is strictly undefined (never throw for empty object or null)
    if (typeof context === "undefined") throw new Error("useToast must be used within a ToastProvider");
    return context;
}
