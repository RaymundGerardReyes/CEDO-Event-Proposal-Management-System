...
const AvatarFallback = React.forwardRef(({ className, children, ...props }, ref) => {
  ...
  // Enhanced color scheme based on Google Auth status (Admin theme)
  const getAvatarColors = React.useCallback(() => {
    if (isFromGoogle) {
      // Google brand colors for Google-authenticated admins
      return {
      ...
      // Admin-specific design for non-Google users
      return {
...
// Enhanced Avatar component with smart Google OAuth integration for Admin
const SmartAdminAvatar = React.forwardRef(({
  className,
  src,
  alt,
  fallbackText,
...
SmartAdminAvatar.displayName = "SmartAdminAvatar"

export { Avatar, AvatarFallback, AvatarImage, SmartAdminAvatar }
