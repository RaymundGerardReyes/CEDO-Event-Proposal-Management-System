...
import { BarChart3, FileText, ClipboardCheck, CalendarDays, PieChart } from "lucide-react"
import {
  Sidebar,
  SidebarContent,
  SidebarHeader,
...
export function AppSidebar() {
  ...
  return (
    ...
    >
      ...
      <SidebarFooter className="mt-auto border-t border-white/10 p-4">{/* Footer content removed */}</SidebarFooter>
    </Sidebar>
  )
}
