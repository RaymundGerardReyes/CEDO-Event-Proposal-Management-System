...
const ReportGenerator = ({ organizations = [], analytics = null }) => {
    ...
    const generateReportData = useCallback(async (params) => {
        try {
            console.log('📊 Frontend: Generating report with parameters:', {
                reportType: params.reportType,
                selectedYear: params.selectedYear,
                selectedMonth: params.selectedMonth,
                selectedOrganizations: params.selectedOrganizations,
    ...
    const handleGenerateReport = useCallback(async () => {
        ...
        try {
            ...
            console.log('📊 Frontend: Starting report generation with params:', {
                reportType,
                selectedYear,
                selectedMonth: reportType === 'monthly' ? selectedMonth : null,
                selectedOrganizations,
