 ...
 * 
 * This script tests the admin proposals API endpoint to ensure it works correctly
 */
...
async function testAdminProposalsEndpoint() {
    console.log('🔧 Testing Admin Proposals Endpoint...');
    console.log('====================================');
    ...
    try {
        ...
        console.log('\n🎉 Admin Proposals Endpoint Test Complete!');
        console.log('==========================================');
